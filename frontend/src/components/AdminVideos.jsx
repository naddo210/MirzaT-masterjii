...
//     try {
//       await axios.post('https://mirzat.onrender.com/api/videos', formData, {
//         headers: {
    ...
    <Container maxWidth="lg" sx={{ py: { xs: 2, sm: 3, md: 4 } }}>
      ...
      >
        ...
        <Button 
          variant="contained" 
          color="primary" 
          onClick={handleOpenDialog}  // Updated click handler
          sx={{ 
            width: { xs: '100%', sm: 'auto' }
          }}
        >
      ...
      >
        ...
        <DialogActions sx={{ p: { xs: 2, sm: 3 }, gap: { xs: 1, sm: 2 } }}>
          <Button onClick={() => setOpen(false)} fullWidth={window.innerWidth < 600}>
            Cancel
          </Button>
          <Button onClick={handleSubmit} variant="contained" fullWidth={window.innerWidth < 600}>
            Upload
          </Button>
        </DialogActions>
      </Dialog>
